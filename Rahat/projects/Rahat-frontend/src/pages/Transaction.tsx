      ...
      <div className="sm:flex sm:items-center">
        <div className="sm:flex-auto">
          ...
          <p className="mt-2 text-sm text-gray-700">
            A list of all transactions in your account including their topic, beneficiary ID, from and to wallet addresses, timestamp,
            transaction hash, amount, and transaction fee.
          </p>
        </div>
