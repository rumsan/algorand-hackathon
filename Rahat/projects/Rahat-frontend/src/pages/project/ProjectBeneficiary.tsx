                    ...
                    <tr key={beneficiary.walletAddress}>
                      ...
                      <td className="whitespace-nowrap py-5 pl-4 pr-3 text-sm sm:pl-0">
                        <div className="flex items-center">
                          ...
                          <div className="ml-4">
                            <Link to={`/admin/beneficiary/${beneficiary.id}`} className="font-medium text-gray-900">
                              {beneficiary.name}
                            </Link>
                          </div>
                        </div>
                      ...
                      <td className="whitespace-nowrap px-3 py-5 text-sm text-gray-500">
                        <Link to={`/admin/beneficiary/${beneficiary.id}`} className="text-gray-900">
                          {beneficiary.email}
                        </Link>
                      </td>
                      <td className="whitespace-nowrap px-3 py-5 text-sm text-gray-500">
                        <Link to={`/admin/beneficiary/${beneficiary.id}`} className="text-gray-500">
                          <TruncatedCell text={beneficiary.walletAddress} />
                        </Link>
                      </td>
                      <td className="whitespace-nowrap px-3 py-5 text-sm text-gray-500">
                        <Link
                          to={`/admin/beneficiary/${beneficiary.id}`}
